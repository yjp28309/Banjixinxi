...
public class BaseDao {
    ...
    public static ResultSet execute2(Connection connection, PreparedStatement pstm, ResultSet rs, String sql) throws Exception {
    	pstm = connection.prepareStatement(sql);
    	rs = pstm.executeQuery();
    	return rs;
    }
    ...
    public static int execute1(Connection connection, PreparedStatement pstm, String sql)
            throws Exception {
        int updateRows = 0;
        pstm = connection.prepareStatement(sql);
        updateRows = pstm.executeUpdate();
